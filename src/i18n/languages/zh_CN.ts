...
export const zh_CN: Translation = {
	...
	[Key.changelogAll]: "全部",
	[Key.changelogFeature]: "功能",
	[Key.changelogImprovement]: "改进",
	[Key.changelogFix]: "修复",
	[Key.changelogRemoval]: "移除",
	[Key.changelogNoData]: "暂无更新日志",
	[Key.categoryList]: "分类列表",
	[Key.categoryPosts]: "分类文章",
	[Key.allCategories]: "全部分类",
	[Key.recentMoments]: "最新动态",
	[Key.portalRecentPosts]: "近期文章",
	[Key.portalRecentMoments]: "近期动态",
	[Key.portalViewAll]: "查看全部",
	[Key.portalViewMore]: "查看更多",
	[Key.portalRunningDays]: "已运行",
	[Key.portalDays]: "天",
	[Key.recentLife]: "最近生活",
	[Key.recentItems]: "最近项目",
	[Key.booksTitle]: "我的书架",
	[Key.booksSubtitle]: "记录读过的每一本书",
	[Key.bookshelfReading]: "在读",
	[Key.bookshelfRead]: "已读",
	[Key.bookshelfWantRead]: "想读",
	[Key.booksNoData]: "暂无书籍",
	[Key.moviesGamesTitle]: "影视游戏",
	[Key.moviesGamesSubtitle]: "记录看过的每一部作品",
	[Key.moviesGamesTabAll]: "全部",
	[Key.moviesGamesTabMovie]: "电影",
	[Key.moviesGamesTabTV]: "剧集",
	...
	[Key.musicPageSubtitle]: "享受音乐的美好",
	[Key.musicPageNoData]: "暂无音乐",
	[Key.siteHeatmap]: "站点热力图",
	[Key.welcomeCardLocation]: "当前位置",
	[Key.welcomeCardGreeting]: "你好",
	[Key.welcomeCardRecentUpdates]: "最近更新",
	[Key.welcomeCardFlipHint]: "点击翻转",
	[Key.welcomeCardDragHint]: "拖拽移动",
	[Key.welcomeCardClose]: "关闭",
	[Key.welcomeCardLearnMore]: "了解更多",
	[Key.welcomeCardRecentLabel]: "最新",
